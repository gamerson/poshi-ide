...
public class PoshiNodeActionManager extends XMLNodeActionManager
{
    ...
    protected void contributeRunAsActions( IMenuManager menu, Node node )
    {
        ...
        contributeAction( addRunAsMenu, new TestcasePoshiRunnerLaunchAction( file, node, sb.toString() ) );
        contributeAction( addRunAsMenu, new TestcaseTomcatLaunchAction( file, node, sb.toString() ) );
        contributeAction( addRunAsMenu, new TestcaseLaunchAction( file, node, sb.toString() ) );
        contributeAction( addRunAsMenu, new RunSeleniumTestLaunchAction( file, node, sb.toString() ) );
        contributeAction( addRunAsMenu, new RunSeleniumTomcatLaunchAction( file, node, sb.toString() ) );
    }
}
