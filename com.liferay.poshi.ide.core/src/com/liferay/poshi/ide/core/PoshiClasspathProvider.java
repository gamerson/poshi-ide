...
public class PoshiClasspathProvider extends AntClasspathProvider
{

    public static final String ID = "com.liferay.poshi.ide.core.PoshiClasspathProvider"; //$NON-NLS-1$

    public PoshiClasspathProvider()
    {
        super();
    }
