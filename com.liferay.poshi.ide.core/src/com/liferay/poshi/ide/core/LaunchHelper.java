...
public class LaunchHelper implements IDebugEventSetListener
{
    ...
    protected String launchConfigTypeId = "org.eclipse.ant.AntLaunchConfigurationType";

    protected boolean launchInBackground = false;
    ...
    public int launch( final ILaunchConfiguration config, final String mode, IProgressMonitor monitor )
